                ...
                if (length && length > 2 && data[0] == '4' && data[1] == '2') {
                        ...
                        if (s != "") {
                                ...
                                if (event == "telemetry") {
                                        ...
                                        if(following_active) {
                                                increment = 0.025*(tgt_follow_speed - car_speed); //P controller
                                        } else {
